                                ...
                                <div className="bg-white py-6 px-4 space-y-6 sm:p-6">
                                    ...
                                    <div className="grid grid-cols-6 gap-6">
                                        ...
                                        <div className="col-span-6 sm:col-span-3">
                                            ...
                                            <select
                                                id="class_id"
                                                value = {data.class_id} onChange={(e) => setData('class_id', e.target.value)}
                                                className={`mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
                                            >
                                                <option value="">
                                                    Select a Class
                                        ...
                                        <div className="col-span-6 sm:col-span-3">
                                            ...
                                            <select
                                                value = {data.section_id} onChange={(e) => setData('section_id', e.target.value)}
                                                id="section_id"
                                                className={`mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
                                            >
                                                <option value="">
                                                ...
                                                {sections.map((section) => {
                                                    ...
                                                    return (
                                                        <option value={section.id} key={section.id} >{section.name} - {section.class_id}</option>
